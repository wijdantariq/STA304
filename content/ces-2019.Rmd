...
Psychology has been at the forefront of most voting decisions in liberal democracies. Citizens typically go through specific thought processes to make their selection. Their selections were potentially based on several different factors such as which candidate was going to solve the problems most personal to the citizen, which candidate was the most qualified, or even which candidate looked most like themselves. Attempting to understand and voter behaviour can give political parties an extra tool in trying to win more votes.

Survey polls are often conducted during election campaign periods precisely for the reason of understanding and predicting election outcomes. Election surveys usually directly ask citizens the question "Which party do you think you will vote for?" Often, 
